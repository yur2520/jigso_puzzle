...
class Volume {
    ...
    constructor(_core = new core_1.Superblock()) {
        ...
        this.rmSync = (path, options) => {
            this._core.rm((0, util_1.pathToFilename)(path), options?.force, options?.recursive);
        };
        this.rm = (path, a, b) => {
            const [opts, callback] = (0, options_1.getRmOptsAndCb)(a, b);
            this.wrapAsync(this._core.rm, [(0, util_1.pathToFilename)(path), opts?.force, opts?.recursive], callback);
        };
